...
const taxPrefs = z.object({
  ...
  defaultDirectTaxActivityId: z.string().trim().max(80).default(""),
  defaultTaxReductionOnTransaction: z.boolean().default(false),
  defaultTaxReductionForAllProducts: z.boolean().default(false),
...
const notificationDebtRoutePatchSchema =
  z.array(z.enum(["owner", "manager", "cashier", "warehouse"])).min(1);
...
export const cameraQuotePrefsSchema = z.object({
  ...
  ptzMaterialProductId: z.string().nullable().default(null),
  indoorInstallationProductId: z.string().nullable().default(null),
  outdoorInstallationProductId: z.string().nullable().default(null),
  ptzInstallationProductId: z.string().nullable().default(null),
...
export const storePrefsSchema = z.object({
  tax: taxPrefs.default({
    ...
    businessActivities: [],
    defaultDirectTaxActivityId: "",
    defaultTaxReductionOnTransaction: false,
    defaultTaxReductionForAllProducts: false,
