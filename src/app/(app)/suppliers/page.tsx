  ...
  return (
    <div className="p-6">
      ...
      <form className="flex items-center gap-3 mb-4" action={Routes.Suppliers}>
        ...
        <button type="submit" className="px-4 py-2 text-sm font-medium rounded-lg border border-border bg-surface">{t("common.search")}</button>
      </form>
              ...
              {rows.map((s) => {
                ...
                return (
                  <tr key={s.id} className="hover:bg-surface-2">
                    ...
                    <td className={cn("px-4 py-3 text-right tabular-nums font-semibold", debt > 0 ? "text-warn" : "text-slate-400")}>
