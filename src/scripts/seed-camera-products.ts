...
const catalog: CatalogProduct[] = [
  ...
  {
    sku: "HK-IP-DS2CD1143G2-LIUF",
    name: "Camera dome IP Hikvision DS-2CD1143G2-LIUF 4MP",
    brand: "Hikvision",
    category: "Camera giám sát",
    costPrice: 1_320_000,
    retailPrice: 1_580_000,
    description: "Camera dome IP 4MP, micro tích hợp, Smart Hybrid Light và IP67/IK08; phù hợp hành lang, quầy thu ngân và khu vực cần chống va đập.",
    warrantyMonths: 24,
    specs: { "Mã đầy đủ": ["DS-2CD1143G2-LIUF"], "Độ phân giải": ["2560 × 1440 (4MP)"], "Kết nối": ["RJ45; PoE 802.3af"], "Ban đêm / bảo vệ": ["IR và đèn trắng 30m; IP67, IK08"], "Tính năng chính": ["Micro tích hợp; phát hiện người/phương tiện"] },
  },
  {
    sku: "HK-PTZ-DS2DE2A404IW-DE3",
    name: "Camera PTZ Hikvision DS-2DE2A404IW-DE3 4MP 4×",
    brand: "Hikvision",
    category: "Camera giám sát",
    costPrice: 2_760_000,
    retailPrice: 3_379_000,
    description: "Camera quay quét IP 4MP zoom quang 4×, phù hợp sân bãi, cổng ra vào và vị trí cần theo dõi linh hoạt.",
    warrantyMonths: 24,
    specs: { "Mã đầy đủ": ["DS-2DE2A404IW-DE3"], "Độ phân giải": ["2560 × 1440 (4MP)"], "Kết nối": ["RJ45; PoE 802.3af hoặc 12VDC"], "Ban đêm / bảo vệ": ["IR đến 20m; IP66, IK10"], "Tính năng chính": ["Quay quét; zoom quang 4×; theo dõi mục tiêu"] },
  },
  {
    sku: "HK-NVR-DS7616NI-K1",
    name: "Đầu ghi NVR Hikvision DS-7616NI-K1 16 kênh",
    brand: "Hikvision",
    category: "Đầu ghi camera",
    costPrice: 1_720_000,
    retailPrice: 2_110_000,
    description: "Đầu ghi NVR 16 kênh cho hệ thống IP dùng switch PoE rời.",
    warrantyMonths: 24,
    specs: { "Số kênh": ["16 camera IP"], "PoE": ["Không tích hợp; dùng switch PoE rời"], "Lưu trữ": ["1 khe HDD"], "Chuẩn nén": ["H.265+/H.265/H.264+/H.264"] },
  },
  {
    sku: "HK-NVR-DS7616NI-K2-16P",
    name: "Đầu ghi NVR Hikvision DS-7616NI-K2/16P 16 kênh PoE",
    brand: "Hikvision",
    category: "Đầu ghi camera",
    costPrice: 4_650_000,
    retailPrice: 5_645_000,
    description: "Đầu ghi NVR 16 kênh tích hợp 16 cổng PoE cho hệ thống IP tập trung.",
    warrantyMonths: 24,
    specs: { "Số kênh": ["16 camera IP"], "PoE": ["16 cổng PoE tích hợp"], "Lưu trữ": ["2 khe HDD"], "Chuẩn nén": ["H.265+/H.265/H.264+/H.264"] },
  },
  {
    sku: "HK-SW-DS3E1518P-SI",
    name: "Switch PoE Hikvision DS-3E1518P-SI 16 cổng Gigabit",
    brand: "Hikvision",
    category: "Thiết bị mạng",
    costPrice: 4_450_000,
    retailPrice: 5_445_000,
    description: "Switch PoE Gigabit 16 cổng cho hệ thống camera IP lớn, có dự phòng mở rộng.",
    warrantyMonths: 24,
    specs: { "Cổng PoE": ["16 cổng Gigabit"], "Uplink": ["2 cổng SFP + 2 cổng RJ45"], "Ứng dụng": ["Hệ thống 9–16 camera IP"] },
  },
  {
    sku: "SG-SKYHAWK-6TB",
    name: "Ổ cứng camera Seagate SkyHawk 6TB",
    brand: "Seagate",
    category: "Ổ cứng camera",
    costPrice: 3_750_000,
    retailPrice: 4_450_000,
    description: "Ổ cứng giám sát chuyên dụng Seagate SkyHawk 6TB dùng cho đầu ghi camera nhiều kênh.",
    warrantyMonths: 24,
    specs: { "Dung lượng": ["6TB"], "Loại sử dụng": ["Ghi hình giám sát 24/7"] },
  },
  {
    sku: "ACC-HIK-RACK-6U",
    name: "Tủ rack treo tường 6U cho đầu ghi camera",
    category: "Vật tư camera",
    costPrice: 580_000,
    retailPrice: 750_000,
    description: "Tủ rack 6U bố trí gọn đầu ghi, switch, UPS và phụ kiện hệ thống camera.",
    specs: { "Quy cách": ["Tủ rack treo tường 6U"], "Ứng dụng": ["Hệ thống 8–16 camera"] },
  },
  {
    sku: "ACC-HIK-MONITOR-22",
    name: "Màn hình giám sát 22 inch Full HD",
    category: "Thiết bị mạng",
    costPrice: 1_550_000,
    retailPrice: 1_890_000,
    description: "Màn hình 22 inch Full HD để xem trực tiếp hệ thống đầu ghi camera.",
    warrantyMonths: 24,
    specs: { "Kích thước": ["22 inch"], "Độ phân giải": ["Full HD"], "Ứng dụng": ["Màn hình giám sát tại chỗ"] },
  },
  {
    sku: "ACC-HIK-SURGE-PER-CAMERA",
    name: "Thiết bị chống sét lan truyền cho camera IP",
    category: "Vật tư camera",
    costPrice: 95_000,
    retailPrice: 150_000,
    description: "Thiết bị chống sét lan truyền cơ bản cho mỗi tuyến camera ngoài trời.",
    specs: { "Đơn vị áp dụng": ["Mỗi camera"], "Ứng dụng": ["Bảo vệ đường mạng/cấp nguồn ngoài trời"] },
  },
  {
    sku: "MEM-HIK-32GB",
  ...
  await db.transaction(async (tx) => {
    for (const item of catalog) {
      const values = {
        ...
        specs: item.sku.startsWith("HK-") || item.sku.startsWith("SG-") || item.sku.startsWith("ACC-HIK-") || item.sku === "UPS-HIK-650VA" || item.sku === "MAT-HIK-IP-PER-CAMERA" || item.sku === "SVC-HIK-IP-INSTALL-PER-CAMERA"
          ? { ...item.specs, "Nguồn giá": ["Khảo sát giá công khai và nhà cung cấp"], "Kiểm tra giá": ["2026-08-02"] }
          : item.specs,
      ...
      await tx
        ...
        .onConflictDoUpdate({
          ...
          set: {
            ...values,
            // Camera images are synchronized separately. Keep them when this catalog row has no local image asset.
            imageUrls: item.image ? values.imageUrls : sql`${products.imageUrls}`,
          },
        });
    }
  });
