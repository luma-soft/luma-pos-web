...
export const productVariantChildSchema = z.object({
  ...
  name: z.string().min(1, { error: "validation.required" }).optional(),
...
export const createProductSchema = z.object({
  ...
  // Units
  baseUnit: z.string().trim().default("cái"),
  ...
  variantTemplateProductId: z.uuid().optional(),
  variantAddValues: z.record(z.string(), z.string()).default({}),
  variantExistingCombinationKeys: z.array(z.string()).default([]),
  ...
  ...value,
  baseUnit:
    value.baseUnit || (value.productKind === "combo" ? "combo" : "cái"),
}));
